...
| `connect4` | **P1 + P2a + P2b + P2c 已交付 —— 能玩、有手感、一家人能一起玩下去了**（人机/双人、按住预览、落子物理与随深度变调的音、威胁高亮与双威胁光环、赢局逐段揭示、减弱动态+舒适模式、中英双语；**让子 / 儿童档 / 对坐模式+猜先 / 双人局对方同意才悔 / 限时模式（默认关）**）。完美求解器通过 Allis 1988 外部真值门禁，20 级明面 AI 阶梯，求解器跑在 Worker 里。⚠ 还差 P3 提示复盘、P4 课程、**美术**。⛔ `Connect 4` 是活商标，泛型词用 `Four in a Row` |
