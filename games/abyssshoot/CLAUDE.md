...
**v1.0 被 4.3(a) 拒审（07-20）→ 整改完成、已重新提交审核（07-22，`WAITING_FOR_REVIEW`，build 2）。** 线上 web：<https://fishshoot.ai-speeds.com>
...
- **整改全链路已完成（2026-07-22）**：改名/去数字/新图标/新截图/ASC PATCH/回信/build 2 重提交，全程记录见 `docs/aso-appstore.md`。等二审结果。
