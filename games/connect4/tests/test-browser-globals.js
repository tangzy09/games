...
const LOAD_ORDER = [
  ...
  // ⭐ P4/P5：课程引擎 / 元游戏 / 变现闸门。三者无跨模块依赖（lessons 吃 review），
  //   但 root.C4Xxx = API 那条浏览器分支同样只有本文件覆盖得到。
  path.join(JS_DIR, 'lessons.js'),
  path.join(JS_DIR, 'meta.js'),
  path.join(JS_DIR, 'shop.js')
];
