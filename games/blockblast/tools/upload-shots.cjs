// games/blockblast/tools/upload-shots.cjs — 把 39 locale × 2 槽位 × 8 张截图传进 App Store Connect
//
// 用法：node games/blockblast/tools/upload-shots.cjs <appStoreVersionId> [locale...]
...
const FIN = 'C:/tmp/blockblast/store-shots/final';
